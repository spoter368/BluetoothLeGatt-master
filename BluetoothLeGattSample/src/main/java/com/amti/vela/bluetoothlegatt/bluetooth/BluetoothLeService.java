...
public class BluetoothLeService extends Service {
    ...
    public void setCharacteristicNotification(final BluetoothGattCharacteristic characteristic,
        ...
        //we need to give the board time to process everything being shoved down its throat
        mHandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                if (MainActivity.NOTIFICATION_UUID.equals(characteristic.getUuid().toString())) {
